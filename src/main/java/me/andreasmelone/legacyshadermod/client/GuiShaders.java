...
public class GuiShaders extends GuiScreen {
        ...
        if (button.enabled) {
            switch (button.id) {
                ...
                case 9:
                    ...
                    button.displayString = "CloudShadow: " + toStringOnOff(Shaders.configCloudShadow);
                    break;
                case 10:
                    ...
                    button.displayString = "HandDepth: " + String.format("%.4f", Shaders.configHandDepthMul);
                    break;
                case 11:
                ...
                case 15:
                    ...
                    button.displayString = "RenderResMul: " + String.format("%.4f", Shaders.configRenderResMul);
                ...
                case 16:
                    ...
                    button.displayString = "ShadowResMul: " + String.format("%.4f", Shaders.configShadowResMul);
                    Shaders.scheduleResizeShadow();
                    break;
                case 17:
                    Shaders.configNormalMap = !Shaders.configNormalMap;
                    button.displayString = "NormapMap: " + toStringOnOff(Shaders.configNormalMap);
                    this.needRefreshResource = true;
                    break;
                case 18:
                    Shaders.configSpecularMap = !Shaders.configSpecularMap;
                    button.displayString = "SpecularMap: " + toStringOnOff(Shaders.configSpecularMap);
                    this.needRefreshResource = true;
                    break;
                case 19:
                    Shaders.configOldLighting = !Shaders.configOldLighting;
                    button.displayString = "OldLighting: " + toStringOnOff(Shaders.configOldLighting);
    ...
    public void drawScreen(int mouseX, int mouseY, float tickDelta) {
        this.shaderList.drawScreen(mouseX, mouseY, tickDelta);
        ...
        this.drawCenteredString(this.fontRenderer, " v2.2.3", this.width - 40, 10, 8421504);
